...
class DateUtil:
    ...
    def get_date_list(
        ...
        Examples:
            >>> DateUtil.get_date_list(start_date='2023-01-01', end_date='2023-01-03')
            ['2023-01-01', '2023-01-02', '2023-01-03']
            >>> DateUtil.get_date_list(start_date=datetime.date(2023, 1, 1), end_date=datetime.date(2023, 1, 3))
...
if __name__ == "__main__":
    ...
    # Example usage
    print(DateUtil.get_date_list(days_relative=7))  # Next 7 days
    print(DateUtil.get_date_list(days_relative=-7)) # Last 7 days
